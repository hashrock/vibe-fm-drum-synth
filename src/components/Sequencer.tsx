    ...
    const initialTracks: TrackData[] = [
      {
        ...
        frequency: 55,
        operators: [
          { frequency: 55, ratio: 1.57, level: 0.30846065929062844, attack: 0.001, decay: 0.2924691461314984, sustain: 0.3052622340820058, release: 0.23572082996985017, feedbackAmount: 0.95 },
          { frequency: 55, ratio: 1.48, level: 0.5927759298844391, attack: 0.001, decay: 0.09971183734862396, sustain: 0.15405327669189317, release: 0.33589217394922644, feedbackAmount: 0.98 },
          { frequency: 55, ratio: 2.33, level: 0.30651959266073736, attack: 0.001, decay: 0.17247350678078033, sustain: 0.010876614372196836, release: 0.2998970050614464, feedbackAmount: 0.85 },
          { frequency: 55, ratio: 1.88, level: 0.47632812369723265, attack: 0.001, decay: 0.15675361302425694, sustain: 0.33193765080781823, release: 0.08266122022775887, feedbackAmount: 0.92 },
        ],
